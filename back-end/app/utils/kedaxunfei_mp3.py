...
class generate_audio_mp3:
    
    # def __init__(self, APPID, APIKey, APISecret, Text):
    def __init__(self, pcm_sequence, text, output_file, voice_name, audio_id):
        # print(text, output_file)

        self.APPID = '9bf42489'
        self.APISecret='MjM4M2E5ZmIwNmY5ZWRhNzA5OTk4MDg5'
        self.APIKey='12b1af5af9fd5869dc9a301246c82502'
        ...
        # self.BusinessArgs = {"aue": "raw", "auf": "audio/L16;rate=16000", "vcn": voice_name, "tte": "utf8"} # aue = raw  pcm
        self.BusinessArgs = {"aue": "lame", "auf": "audio/L16;rate=16000", "vcn": voice_name, "tte": "utf8"} # aue = lame mp3
    ...
    def on_message(self, ws, message):
        try:
            ...
            if status == 2:
                ...
                # new_audio = Audios.query.get(self.audio_id)
                # if new_audio:
                #     new_audio.status = 0
                #     db.session.commit()
                # print('new_audio:', new_audio)
                print("ws is closed 2")
