...
<script>
const baseUrl = "https://weitang.tuozhanad.com";
  ...
  methods: {
    getStatistics() {
      ...
      fetchStatistics().then(response => {
        ...
        this.List1 = this.data.details.filter(i => i.id <= 19);
        this.List2 = this.data.details.filter(i => i.id > 19 && i.id <= 38);
        this.List3 = this.data.details.filter(i => i.id > 38 && i.id <= 57);
        this.List4 = this.data.details.filter(i => i.id > 57 && i.id <= 76);
        this.List5 = this.data.details.filter(i => i.id > 76 && i.id <= 95);
