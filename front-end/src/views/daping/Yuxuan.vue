...
<script>
const baseUrl = "https://zhiguo.tuozhanad.com";
...
export default {
  ...
  data: () => ({
    ...
    autoPlay: true,
    audio_url: "https://weitang.tuozhanad.com/audios/coloredeer4.mp3",
    data: "",
    textList: [],
    marqueeList: [],
  ...
  methods: {
    getStatistics() {
      ...
      fetchStatistics().then(response => {
        ...
        this.List1 = this.data.details.filter(i => i.id <= 22);
        this.List2 = this.data.details.filter(i => i.id > 22 && i.id <= 44);
        this.List3 = this.data.details.filter(i => i.id > 44 && i.id <= 66);
        this.List4 = this.data.details.filter(i => i.id > 66 && i.id <= 88);
        this.List5 = this.data.details.filter(i => i.id > 88 && i.id <= 110);
